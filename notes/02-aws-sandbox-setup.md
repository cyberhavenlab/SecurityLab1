...
- Create a single notes repository for all deliverables.

## AWS account setup

1. Sign in to the AWS console as root.
2. Enable MFA on the root user.
3. Turn on access to Billing and Cost Management for IAM if needed.
4. Create a budget with a $5 alert threshold.
5. Confirm billing alerts send to your lab email.
...
- Read-only user: scripting, inventory, audit-style checks.
